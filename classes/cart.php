...
<?php
	...
	class cart
	{
		...
		public function get_inbox_cart(){
			$query = "SELECT * FROM ChiTietDatHang, DatHang ,HangHoa, KhachHang, LoaiHangHoa WHERE LoaiHangHoa.MaLoaiHang=HangHoa.MaLoaiHang and DatHang.MSKH=KhachHang.MSKH and DatHang.SoDonDH=ChiTietDatHang.SoDonDH and ChiTietDatHang.MSHH=HangHoa.MSHH order by ChiTietDatHang.SoDonDH desc ";
		...
		public function get_product_cart($MSKH){
			...
			$query="SELECT ChiTietDatHang.SoDonDH,chitietdathang.Location,HangHoa.TenHH, HangHoa.Gia,sum(chitietdathang.SoLuong) as SoLuong FROM ChiTietDatHang, HangHoa, DatHang where ChiTietDatHang.MSHH=HangHoa.MSHH  and ChiTietDatHang.SoDonDH=DatHang.SoDonDH  and DatHang.MSKH='0' group by ChiTietDatHang.MSHH";
			$result=$this->db->select($query);
			return $result;
		}
