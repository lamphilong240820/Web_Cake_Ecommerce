              ...
              ?>
                  <div class="card-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                      <label>Tên danh mục bánh</label>
                      <input type="text" name="TenLoaiHang" class="form-control" placeholder="Nhập tên bánh...">
                    </div>
                  ...
                  <div class="card-footer text-right">
                    <input class="btn btn-primary mr-1" type="submit" name="insert" value="Thêm"/>
